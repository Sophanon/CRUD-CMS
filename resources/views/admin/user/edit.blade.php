                ...
                <div class="card-body">
                    <form method="POST" action="/admin/user/update/{{$user->id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="image" class="col-md-6 col-form-label text-md-right">Profile</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" id="date" name="dob" class="form-control @error('dob') is-invalid @enderror" value="{{$user->dob}}" required autocomplete="email">
                                @error('dob')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
